...
function ageClassification(n) {
  ...
  return n <= 0 ? null : n <= 24 ? 'детский возраст' : n <= 44 ? 'молодой возраст' : n <= 65 ? 'средний возраст' : n <= 75 ? 'пожилой возраст' : n <= 90 ? 'старческий возраст' : n <= 122 ? 'долгожители' : n > 122 ? null : null
}
...
console.log(mainFunc(6, 6, cbRandom)) //→ случайно от 2 до 5 включительно
